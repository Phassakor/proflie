    ...
    return(
        <div>
            <div className="container">
                ...
                <div className='frame'>
                    <h3>Ball Break Out Ver.<span id="gamelevel"></span></h3>
                    <h4>Life Remaining: <span id="liferemaining"></span></h4>
                    <div>
                        <h3 id="gameover" className='ov'></h3>
                        <button id='btAgain' className='bt2' onClick={Reload}>Play Again</button>
                    </div>
                </div>
            </div>
            <div className='cen'>
